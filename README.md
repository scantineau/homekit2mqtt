...
## Build and run local Docker container
    ...
    source locally: docker build -t homekit2mqtt .
    
    from docker hub: docker pull matsekberg/homekit2mqtt:latest

    docker run -d -p 51888:51888 -p 51826:51826 --env-file /Users/meg/mconfig/ha/homekit.env --mount type=bind,source=/Users/meg/mconfig/ha/hk2mqttconfig.json,target=/hk2mqttconfig.json matsekberg/homekit2mqtt
